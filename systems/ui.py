...
def draw_screen(screen, surface, font, bg_color, lines, distance, high_score, pause, game_speed, render=True):
    ...
    return lines, pygame.Rect(0, 0, WIDTH, 50), pygame.Rect(0, HEIGHT - 50, WIDTH, 50)