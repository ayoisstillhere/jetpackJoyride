...
if __name__ == '__main__':
    ...
    checkpoint_callback = CheckpointCallback(
        ...
        name_prefix="ppo_jetpack_checkpoint"  # 文件名前缀
    )

    # 开始训练
    print("开始训练...")
    model.learn(total_timesteps=400_000, reset_num_timesteps=False, callback=checkpoint_callback)

    # 训练结束后保存最终模型
    model.save("ai/ppo_jetpack_agent")
